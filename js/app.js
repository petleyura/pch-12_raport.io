(() => {
    ...
    let masterTools = [ {
        ...
        model: "АБ-2",
        workshops: "ПД-15",
        "master-workhop": "Тесленко Євген Вікторович",
        count: "1.000 ",
        "write-off": "1.000 "
    }, {
        ...
        model: "ЕД-2",
        workshops: "ПЧУ-2",
        "master-workhop": "Ядревський Олександр Борисович",
        count: "1.000 ",
        "write-off": "0.000 "
    }, {
        ...
        "id-tool": "1760402001518",
        "name-tool": "бензоагрегат АБ-4",
        tool: "Пересувна електростанція 4 кВт (АБ-4)",
        model: "АБ-4",
        workshops: "ПД-11",
        "master-workhop": "Кадрецький Володимир ",
        count: "1.000 ",
        "write-off": "0.000 "
    }, {
        ...
        "name-tool": "Газонокосилка Husgvarna535 RX",
        tool: "Кущоріз",
        model: "Husqvarna 535 ",
        workshops: "ПД-2",
        "master-workhop": "Чуприна С. А.",
    ...
    class RadioList {
        ...
        filterArrWorksopsAndTools(event) {
            ...
            console.log("class RadioList: filterArrWorksopsAndTools");
            console.log("event");
            console.log(event);
        ...
        renderListFilterMasterTool() {
            ...
            for (let i = 0; i < this.filterMasterTools.length; i++) {
                console.log(this.filterMasterTools[i]);
                ...
                this.input.addEventListener("click", (event => {
                    ...
                    console.log(` - - this.masterToolObg `);
                    console.log(this.masterToolObg);
    ...
    class RenderListNorm {
        ...
        getModelTools(event) {
            ...
            console.log("class RenderListNorm : getModelTools(event)");
            console.log(someOb);
            this.model = someOb;
    ...
    class FuelConsumptionCalculations {
        ...
        getNorm(event) {
            ...
            console.log(`Це прийшла норма ${this.norm}`);
        }
        refuelingTool() {
        ...
        sumRefueling() {
            ...
            this.refueling.forEach((el => sumOil += Math.floor(el.number)));
            console.log(`Отримано пального - ${sumOil}`);
            this.starGas = sumOil;
            console.log(this.starGas);
            this.spanIDRemainingFuel.innerText = `${this.starGas} л.`;
        }
        sumJomToolOperation() {
            let sumJob = 0;
            this.toolOperation.forEach((el => sumJob += Math.floor(el.number)));
        ...
        fuelRemainingTotal() {
            ...
            let fuel = this.starGas - Math.floor(this.resultJobFact());
    ...
    class Slider {
        ...
        nexEl() {
            console.log(this.active.nextElementSibling);
